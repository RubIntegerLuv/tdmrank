...
import { Firestore, collection, addDoc, doc, updateDoc, onSnapshot, getDoc } from '@angular/fire/firestore';
...
export class CreateMatchPage implements OnInit {
  ...
  async crearPartido() {
  this.arbitro = await this.authService.getCurrentUserData(); // <--- CAMBIA AQUÍ
